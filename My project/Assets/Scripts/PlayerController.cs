...
public class PlayerController : MonoBehaviour {
    ...
    public float minSpeed = 2f;          // Very easy at start
    public float maxSpeed = 15f;         // Cap at high levels
    public int tilesPerLevel = 40;       // Same as TileSpawner
    public int maxLevel = 10;            // After this, speed stays max
    ...
    void UpdateLevelSpeed(){
        ...
        // Clamp level so it doesn't go infinite
        int clampedLevel = Mathf.Min(currentLevel, maxLevel);

        // Smooth progression from minSpeed -> maxSpeed
